        ...
        if (createResponse.ok) {
            ...
            for (let i = 0; i < evolutionMessages.length; i++) {
                ...
                if (evolutionResponse.ok) {
                    ...
                    const reply = evolutionData.message || '';
            ...
            if (profileResponse.ok) {
                ...
                if (girlfriendParams && Object.keys(girlfriendParams).length > 0) {
                    ...
                    const specialModes = params.specialModes || {};
                    console.log(`     特殊模式: 夜猫子=${specialModes.nightOwlMode || false}, 起床气=${specialModes.grumpyMode || false}`);
